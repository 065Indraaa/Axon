...
export default function Dashboard() {
    ...
    const { location, city, currency, formatAmount } = useAxon();
                        ...
                        {[
                            ...
                            >
                                <div className="flex justify-between items-center py-2 hover:bg-white px-2 rounded-lg transition -mx-2">
                                    <div className="flex items-center gap-3">
                                        <div className="w-9 h-9 bg-gray-100 rounded-swiss flex items-center justify-center text-sm border border-gray-200 group-hover:border-axon-neon transition-colors">
